...
function getAngleBetweenVectors(x1, y1, x2, y2) {
  ...
  const vector1Length = (x1 ** 2 + y1 ** 2) ** 0.5;
  const vector2Length = (x2 ** 2 + y2 ** 2) ** 0.5;
  const vectorsLengthSum = vector1Length * vector2Length;
  return Math.acos(scalarProduct / vectorsLengthSum);
}
